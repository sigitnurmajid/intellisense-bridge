...
import { InfluxDriver } from './Driver/InfluxDriver'
...
export default class InfluxProvider {
  ...
  public registerHealthCheck() {
    this.app.container.with(
      ['Adonis/Core/Config', 'Zhelda/Influx', 'Adonis/Core/HealthCheck'],
      (Config, Influx, HealthCheck) => {
        if (Config.get('influx').healthCheck) {
  ...
  public register() {
    this.app.container.singleton('Zhelda/Influx', () => {
